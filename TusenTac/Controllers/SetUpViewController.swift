...
class SetUpViewController: UITableViewController, UITextFieldDelegate {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        if      indexPath.section == 0 && indexPath.row == 2 { toggleDatepicker(1) } // morningTimePicker
    ...
    override func tableView(tableView: UITableView, heightForRowAtIndexPath indexPath: NSIndexPath) -> CGFloat {
        ...
        if  (morningTimePickerHidden && indexPath.section == 0 && indexPath.row == 3) ||
            (nightTimePickerHidden && indexPath.section == 0 && indexPath.row == 6)
        {
            return 0
        }
