...
class SettingsViewController: UITableViewController {
    ...
    @IBOutlet weak var nightTimeTextField: UITextField!
   ...
   /* @IBAction func notificationsChanged(sender: AnyObject) {
    ...
    @IBAction func morningTimeChaned(sender: AnyObject) {
    ...
    @IBAction func morningDosageChanged(sender: AnyObject) {
        UserDefaults.setObject(morningDosageTextField.text, forKey: UserDefaultKey.mDosage)
    }

    
    @IBAction func nightDosageChanged(sender: AnyObject) {
        UserDefaults.setObject(nightTimeTextField.text, forKey: UserDefaultKey.nDosage)
    }
